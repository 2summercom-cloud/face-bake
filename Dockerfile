...
RUN mkdir -p /workspace/models && \
    wget -O /workspace/models/emoca_weights.zip https://emoca.is.tue.mpg.de/emoca_model.zip && unzip /workspace/models/emoca_weights.zip -d /opt/emoca && \
    wget -O /workspace/models/deca_model.tar https://github.com/YadiraF/DECA/releases/download/v1.0/DECA_model.tar && tar -xf /workspace/models/deca_model.tar -C /opt/DECA && \
